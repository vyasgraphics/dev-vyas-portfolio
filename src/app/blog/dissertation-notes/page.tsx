  ...
  return (
    <BlogPostLayout slug="dissertation-notes">
      ...
      <p>
        ...
        measures two scores instead of one.
      </p>
      ...
      <p>
        ...
        news search task itself. Reading speed was measured covertly along the way too, framed to participants as a
        short comprehension check rather than a timed test, since telling people you&apos;re timing how fast they
        read tends to change how naturally they read. Everyone received a full debrief explaining the real purpose
        once they&apos;d finished, and the whole design went through full ethical approval at York before any data
        was collected.
      </p>
