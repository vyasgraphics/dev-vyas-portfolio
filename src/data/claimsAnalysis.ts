...
export const claimsRows: ClaimRow[] = [
  {
    feature: "Gap Finder",
    practice: "Maya attempts \u201cmental math\u201d (travel + activity + shower time), experiences cognitive overload, and abandons the task (\u201cLogistics Paralysis\u201d).",
    positiveTitle: "Cognitive Offloading",
    positiveText: "Automating the scheduling logistics removes the mental barrier to entry, increasing the likelihood of utilizing short breaks.",
  ...
  },
  {
    ...
    practice: "Liam approaches a location, imagines or sees a crowd, feels \u201cFear of Judgment,\u201d and retreats to his dorm.",
  ...
  },
  {
    ...
    positiveText: "Empowers the user to filter the environment to their comfort level immediately. Validates their need for privacy rather than forcing exposure.",
    negativeTitle: "Echo Chamber Risk",
    negativeText: "May facilitate \u201cSafety Behaviors\u201d (a CBT concept) where the user avoids anxiety triggers permanently rather than gradually overcoming the fear of crowds.",
  },
];
